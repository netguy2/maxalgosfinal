...
def transform_data(data, client_id=None, auth_token=None):
    """
    Transforms Max Algos order format to Pocketful order format.
    ...
    Args:
        data: Max Algos order data dictionary
...
def transform_modify_order_data(data, client_id=None):
    """
    Transforms Max Algos order modification format to Pocketful order format.
...
def map_order_type(pricetype):
    """
    Maps Max Algos pricetype to Pocketful order type.
    """
    order_type_mapping = {
        "MARKET": "MARKET",
        "LIMIT": "LIMIT",
...
def map_product_type(product):
    """
    Maps Max Algos product type to Pocketful product type.
    """
