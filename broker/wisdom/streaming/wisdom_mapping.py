...
class WisdomExchangeMapper:
    """Maps between Max Algos exchange codes and Wisdom XTS specific exchange types"""

    # Exchange type mapping for Wisdom XTS broker
    # Format: {Max Algos_Exchange: Wisdom_Exchange_Code}
    ...
    # Reverse mapping for converting Wisdom exchange codes to Max Algos format
    # Format: {Wisdom_Exchange_Code: Max Algos_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert Max Algos exchange code to Wisdom XTS specific exchange type
    ...
    @staticmethod
    def get_maxalgos_exchange(wisdom_code):
        """
        Convert Wisdom XTS exchange code to Max Algos exchange code
