"""
delta_adapter.py
Max Algos WebSocket adapter for Delta Exchange.
...
class DeltaWebSocketAdapter(BaseBrokerWebSocketAdapter):
    ...
    def initialize(
        ...
        if auth_data:
            ...
            # Max Algos stores the api_key as the auth token
    ...
    def _on_data(self, wsapp, msg: dict) -> None:
        ...
        try:
            ...
            # Find ALL Max Algos subscriptions matching this broker symbol + channel.
    ...
    def _handle_private_event(self, event_type: str, msg: dict) -> None:
        ...
        Max Algos service can subscribe to them via ZeroMQ:
    ...
    def _normalise_ticker(self, msg: dict, cache_key: str) -> dict:
        """
        Map v2/ticker fields to Max Algos market data format.
    ...
    def _normalise_l2_orderbook(self, msg: dict, cache_key: str) -> dict:
        """
        Map l2_orderbook message to Max Algos depth format.
