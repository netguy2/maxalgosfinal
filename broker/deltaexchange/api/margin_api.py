...
def calculate_margin_api(positions, auth):
    ...
    Args:
        positions: List of Max Algos-format position dicts
            {symbol, exchange, action, quantity, product, price, pricetype}
        auth (str): api_key stored in the Max Algos auth DB.

    Returns:
        Tuple of (MockResponse, response_data) matching Max Algos broker interface.
    """
    api_key = auth
    api_secret = os.getenv("BROKER_API_SECRET", "")
