...
def get_api_response(endpoint, auth, method="GET", payload="", params=None):
    ...
    Args:
        ...
        auth:     api_key (BROKER_API_KEY stored in Max Algos DB after login)
...
def get_positions(auth):
    ...
    appear in the Max Algos position book alongside derivative positions.
    """
    positions = []
...
def close_all_positions(current_api_key, auth):
    ...
    for pos in positions:
        ...
        # Resolve Max Algos symbol from DB.
