# api/funds.py
# Delta Exchange wallet balance → Max Algos margin format
# Endpoints:
...
def get_margin_data(auth_token):
    """
    Fetch wallet balance from Delta Exchange and return it in Max Algos margin format.
    ...
    Args:
        auth_token (str): api_key stored in Max Algos auth DB after login.

    Returns:
        dict: Max Algos standard margin dict, or DEFAULT_MARGIN_RESPONSE on failure.
    """
    api_key = auth_token
