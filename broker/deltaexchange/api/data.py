...
class BrokerData:
    ...
    # Delta Exchange supported candle resolutions mapped from Max Algos interval codes.
    ...
    def __init__(self, auth_token: str):
        """Initialise with the api_key stored in the Max Algos auth DB."""
    ...
    def get_quotes(self, symbol: str, exchange: str) -> dict:
        ...
        Field mapping (ticker result → Max Algos):
    ...
    def get_option_chain(
        ...
        Args:
            ...
            exchange:   Max Algos exchange code.  ``"CRYPTO"`` for all Delta
    ...
    def get_intervals(self) -> list:
        """
        Return the list of supported Max Algos interval codes for Delta Exchange.
        """
    ...
    def _get_br_symbol(self, symbol: str, exchange: str) -> str:
        """
        Resolve Max Algos symbol → Delta Exchange contract symbol (brsymbol).
