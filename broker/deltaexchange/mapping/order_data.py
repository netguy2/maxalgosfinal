...
def map_order_data(order_data):
    """
    Normalises a list of Delta Exchange order dicts to the Max Algos internal format.
...
def map_trade_data(trade_data):
    """
    Normalises a list of Delta Exchange fill/trade dicts to the Max Algos internal format.
...
def transform_tradebook_data(tradebook_data):
    """
    Transform Delta Exchange fill/trade data to Max Algos standard format.
...
def map_position_data(position_data):
    """
    Normalises a list of Delta Exchange position dicts to the Max Algos internal format.
...
def transform_positions_data(positions_data):
    """
    Transform positions data to Max Algos standard format.
    Matches the structure used by Angel broker for consistency.

    Max Algos Standard Fields:
    ...
    try:
        ...
        for position in positions_data:
            ...
            # Max Algos standard format (matching Angel broker structure)
            transformed_position = {
                ...
                ),  # Float as per Max Algos standard
