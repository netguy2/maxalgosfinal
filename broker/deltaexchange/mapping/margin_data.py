...
# Mapping Max Algos margin positions to Delta Exchange margin_required API format
...
def transform_margin_positions(positions):
    """
    Transform Max Algos margin position list to Delta Exchange format.

    Each Max Algos position is converted to a dict with the fields needed
    ...
    Args:
        positions: List of dicts in Max Algos format
...
def parse_margin_response(response_data):
    ...
    Max Algos margin format (3 fields):
