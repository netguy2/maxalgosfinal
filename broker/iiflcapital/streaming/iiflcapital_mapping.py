"""
Helpers for translating between Max Algos's market-data conventions and the
...
# Max Algos exchanges that are routed to the index MQTT topic prefix
...
# Max Algos exchanges that support open-interest data. Anything outside this
