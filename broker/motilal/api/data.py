...
class BrokerData:
    ...
    def get_quotes(self, symbol: str, exchange: str) -> dict:
        ...
        Args:
            symbol: Trading symbol (Max Algos format)
        ...
        try:
            ...
            # Map Max Algos exchange to Motilal exchange
            ...
            # Return quote in Max Algos common format
            return {
    ...
    def get_depth(self, symbol: str, exchange: str) -> dict:
        ...
        This follows the Max Algos standard structure matching Angel and other brokers.
        ...
        try:
            ...
            # Create a normalized depth structure in the Max Algos format
            ...
            # Return in Angel's Max Algos standard format (matching lines 524-537 of angel/api/data.py)
            return {
                "bids": formatted_bids,
                "asks": formatted_asks,
                "high": high,
