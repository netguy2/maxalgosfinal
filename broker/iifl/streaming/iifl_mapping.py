...
class IiflExchangeMapper:
    """Maps between Max Algos exchange codes and Iifl XTS specific exchange types"""

    # Exchange type mapping for Iifl XTS broker
    # Format: {Max Algos_Exchange: Iifl_Exchange_Code}
    ...
    # Reverse mapping for converting Iifl exchange codes to Max Algos format
    # Format: {Iifl_Exchange_Code: Max Algos_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert Max Algos exchange code to Iifl XTS specific exchange type
    ...
    @staticmethod
    def get_maxalgos_exchange(iifl_code):
        """
        Convert Iifl XTS exchange code to Max Algos exchange code
