...
def transform_data(data, token):
    """
    Transforms the Max Algos API request structure to Indmoney API structure.
    ...
    # Basic mapping from Max Algos to Indmoney
...
def transform_modify_order_data(data):
    """
    Transforms Max Algos modify order data to Indmoney format.
    """
    transformed = {
...
def map_order_type(pricetype):
    """
    Maps Max Algos pricetype to Indmoney order_type.
    """
    order_type_mapping = {
        "MARKET": "MARKET",
...
def map_exchange(br_exchange):
    """
    Maps Indmoney exchange back to Max Algos exchange.
    """
...
def reverse_map_product_type(product):
    """
    Maps Indmoney product type back to Max Algos product type.
    """
