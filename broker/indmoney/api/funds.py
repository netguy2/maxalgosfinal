...
# Default response format for margin data (Max Algos standard format)
...
def get_margin_data(auth_token):
    ...
    try:
        ...
        try:
            ...
            # Max Algos standard required keys (matching Angel broker format)
            required_keys = [
                "availablecash",
                "collateral",
                "m2mrealized",
            ...
            # Prepare the response in Max Algos standard format
            processed_data = {}

            # Map INDmoney fields to Max Algos standard fields
            field_mapping = {
