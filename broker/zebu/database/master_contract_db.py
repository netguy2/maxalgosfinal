...
def delete_symtoken_table():
    ...
    SymToken.query.filter(SymToken.broker == "zebu").delete(synchronize_session=False)
    db_session.commit()
...
def process_zebu_nse_data(output_path):
    """
    Processes the Zebu NSE data (NSE_symbols.txt) to generate Max Algos symbols.
...
def process_zebu_nfo_data(output_path):
    """
    Processes the Zebu NFO data (NFO_symbols.txt) to generate Max Algos symbols.
...
def process_zebu_cds_data(output_path):
    """
    Processes the Zebu CDS data (CDS_symbols.txt) to generate Max Algos symbols.
    Handles both futures and options formatting.
    """
...
def process_zebu_mcx_data(output_path):
    """
    Processes the Zebu MCX data (MCX_symbols.txt) to generate Max Algos symbols.
    Handles both futures and options formatting.
    """
...
def process_zebu_bse_data(output_path):
    """
    Processes the Zebu BSE data (BSE_symbols.txt) to generate Max Algos symbols.
...
def process_zebu_bfo_data(output_path):
    """
    Processes the Zebu BFO data (BFO_symbols.txt) to generate Max Algos symbols and correctly extract the name column.
