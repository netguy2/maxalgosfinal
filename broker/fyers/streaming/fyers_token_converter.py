...
Converts Max Algos symbols to Fyers HSM format for WebSocket streaming
...
class FyersTokenConverter:
    ...
    def get_brsymbols_from_database(
        ...
        """
        Lookup brsymbols from database using Max Algos symbol and exchange
    ...
    def convert_maxalgos_symbols_to_hsm(
        self, symbol_info_list: list[dict], data_type: str = "SymbolUpdate"
    ) -> tuple[list[str], dict[str, str], list[str]]:
        """
        Convert Max Algos symbols to HSM tokens using database lookup for brsymbols
        ...
        try:
            ...
            # self.logger.info(f"Converting Max Algos symbols: {symbol_exchange_pairs}")
            ...
            self.logger.error(f"Max Algos symbol conversion error: {e}")
    ...
    def convert_maxalgos_to_fyers_symbol(self, exchange: str, symbol: str) -> str:
        """
        Convert Max Algos format (exchange, symbol) to Fyers symbol format
