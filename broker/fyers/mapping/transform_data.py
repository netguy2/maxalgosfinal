...
def transform_data(data):
    """
    Transforms the Max Algos Platform API request structure to the format expected by the Fyers API.
    """
...
def map_order_type(pricetype):
    """
    Maps the Max Algos pricetype to the Fyers order type.
    """
...
def map_action(action):
    """
    Maps the Max Algos action to the Fyers side.
    """
...
def map_product_type(product):
    """
    Maps the Max Algos product type to the Fyers product type.
    """
...
def reverse_map_product_type(product):
    """
    Reverse maps the Fyers product type to the Max Algos product type.
    """
    ...
    if oa_product is None:
        logger.warning(
            f"Unknown Fyers product type '{product}' received. Cannot map to Max Algos product type."
        )
    return oa_product
