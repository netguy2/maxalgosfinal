...
def transform_margin_positions(positions):
    """
    Transform Max Algos margin position format to Fyers margin format.
...
def parse_margin_response(response_data):
    """
    Parse Fyers margin response to Max Algos standard format.
    ...
    try:
        ...
        # Return standardized format matching Max Algos specification
