...
def get_client_id(api_key=None):
    ...
    Args:
        api_key: Max Algos API key (optional)
...
def parse_basket_margin_response(response_data):
    ...
    can use camelCase. Accept both and expose Max Algos's common margin fields.
    """
    try:
...
def calculate_margin_api(positions, auth, api_key=None):
    ...
    Args:
        ...
        api_key: Max Algos API key (optional, for client ID lookup)
