...
class FivepaisaXTSExchangeMapper:
    """Maps between Max Algos exchange codes and Fivepaisa XTS specific exchange types"""

    # Exchange type mapping for Fivepaisa XTS broker
    # Format: {Max Algos_Exchange: Fivepaisa_Exchange_Code}
    ...
    # Reverse mapping for converting Fivepaisa exchange codes to Max Algos format
    # Format: {Fivepaisa_Exchange_Code: Max Algos_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert Max Algos exchange code to Fivepaisa XTS specific exchange type
    ...
    @staticmethod
    def get_maxalgos_exchange(fivepaisaxts_code):
        """
        Convert Fivepaisa XTS exchange code to Max Algos exchange code
