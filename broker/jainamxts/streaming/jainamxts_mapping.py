...
class JainamXTSExchangeMapper:
    """Maps between Max Algos exchange codes and JainamXTS specific exchange types"""

    # Exchange type mapping for JainamXTS broker
    # Format: {Max Algos_Exchange: JainamXTS_Exchange_Code}
    ...
    # Reverse mapping for converting JainamXTS exchange codes to Max Algos format
    # Format: {JainamXTS_Exchange_Code: Max Algos_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert Max Algos exchange code to JainamXTS specific exchange type
    ...
    @staticmethod
    def get_maxalgos_exchange(jainamxts_code):
        """
        Convert JainamXTS exchange code to Max Algos exchange code
