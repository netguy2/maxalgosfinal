...
class UpstoxExchangeMapper:
    """Maps between Max Algos exchange codes and Upstox specific exchange types"""

    # Exchange type mapping for Upstox broker
    # Format: {Max Algos_Exchange: Upstox_Exchange_Code}
    EXCHANGE_TYPES = {
        # NSE Segments
    ...
    # Reverse mapping for converting Upstox exchange codes to Max Algos format
    # Format: {Upstox_Exchange_Code: Max Algos_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert Max Algos exchange code to Upstox specific exchange type
    ...
    @staticmethod
    def get_maxalgos_exchange(upstox_code):
        """
        Convert Upstox exchange code to Max Algos exchange code
