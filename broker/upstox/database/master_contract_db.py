...
def delete_symtoken_table():
    ...
    SymToken.query.filter(SymToken.broker == "upstox").delete(synchronize_session=False)
    db_session.commit()
...
def process_upstox_json(path):
    ...
    exchange_map = {
        ...
        "BCD_FO": "BCD",
        "MCX_FO": "MCX",
        # Upstox quote-only world feeds — folded into Max Algos's GLOBAL_INDEX
    ...
    # NSE Index Symbol Mapping (Upstox trading_symbol → Max Algos format)
    ...
    # Mapped to Max Algos standard symbols listed in docs/prompt/symbol-format.md.
