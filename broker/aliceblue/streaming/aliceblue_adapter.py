...
class AliceblueWebSocketAdapter(BaseBrokerWebSocketAdapter):
            ...
            with self.lock:
                ...
                if mode > existing_mode:
                    self.subscriptions[sub_key] = {
                        ...
                        "original_symbol": symbol,  # Store original Max Algos symbol for lookup
                        "original_exchange": exchange,  # Store original Max Algos exchange
    ...
    def _on_data_received(self, parsed_data):
        ...
        try:
            ...
            # Also, for NFO/BFO symbols, AliceBlue returns broker symbols but we need Max Algos symbols
