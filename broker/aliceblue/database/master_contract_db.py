...
def delete_symtoken_table():
    ...
    SymToken.query.filter(SymToken.broker == "aliceblue").delete(synchronize_session=False)
    db_session.commit()
    ...
    token_df["symbol"] = token_df["symbol"].replace(
        {
            ...
            # BSE Index Symbols (AliceBlue -> Max Algos)
            "SNSX50": "SENSEX50",
