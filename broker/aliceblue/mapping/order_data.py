...
def normalize_order(order):
    ...
    return {
        ...
        "Pcode": reverse_map_product_type(order.get("product", ""), order.get("exchange", "")),
        "Status": status,
...
def normalize_trade(trade):
    ...
    return {
        ...
        "Pcode": reverse_map_product_type(trade.get("product", ""), trade.get("exchange", "")),
        "Prctype": prctype,
...
def normalize_position(position):
    ...
    return {
        ...
        "Pcode": reverse_map_product_type(position.get("product", ""), position.get("exchange", "")),
