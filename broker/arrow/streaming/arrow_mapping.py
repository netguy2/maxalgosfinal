...
class ArrowExchangeMapper:
    """Max Algos <-> Arrow exchange codes. Indices collapse to Arrow 'INDEX' on
    ...
    instrument. We retain the Max Algos exchange per token for topic routing."""
...
class ArrowCapabilityRegistry:
    ...
    # Max Algos capability -> Arrow subscription mode.
    ...
    # Max Algos numeric mode (1/2/3) -> Arrow subscription mode.
    MODE_MAP = {
        1: "ltpc",
        2: "quote",
        3: "full",
