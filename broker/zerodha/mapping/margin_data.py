...
def transform_margin_positions(positions):
    """
    Transform Max Algos margin position format to Zerodha margin format.
...
def map_product_type(product):
    """
    Maps Max Algos product type to Zerodha product type.
...
def map_order_type(pricetype):
    """
    Maps Max Algos price type to Zerodha order type.
...
def parse_margin_response(response_data):
    """
    Parse Zerodha margin response to Max Algos standard format.
