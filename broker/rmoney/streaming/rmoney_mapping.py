...
class RMoneyExchangeMapper:
    """Maps between Max Algos exchange codes and RMoney XTS specific exchange types"""

    # Exchange type mapping for RMoney XTS broker
    # Format: {Max Algos_Exchange: RMoney_Exchange_Code}
    ...
    # Reverse mapping for converting RMoney exchange codes to Max Algos format
    # Format: {RMoney_Exchange_Code: Max Algos_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert Max Algos exchange code to RMoney XTS specific exchange type
    ...
    @staticmethod
    def get_maxalgos_exchange(rmoney_code):
        """
        Convert RMoney XTS exchange code to Max Algos exchange code
