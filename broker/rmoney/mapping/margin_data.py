...
def transform_margin_positions(positions):
    """
    Transform Max Algos margin position format to RMoney XTS margin API format.
...
def parse_margin_response(response_data):
    """
    Parse RMoney XTS margin calculator response to Max Algos standard format.
    ...
    Returns:
        dict: Parsed margin data in Max Algos format
    """
