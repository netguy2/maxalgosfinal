...
class FivePaisaExchangeMapper:
    """Maps Max Algos exchange codes to 5Paisa-specific exchange codes"""
    ...
    def get_exchange_code(exchange: str) -> str:
        """
        Convert Max Algos exchange code to 5Paisa exchange code

        Args:
            exchange (str): Max Algos exchange code (e.g., 'NSE', 'BSE', 'NFO')
    ...
    def get_exchange_type(exchange: str) -> str:
        """
        Convert Max Algos exchange to 5Paisa exchange type
