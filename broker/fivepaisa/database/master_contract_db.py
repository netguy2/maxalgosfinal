...
def delete_symtoken_table():
    ...
    SymToken.query.filter(SymToken.broker == "fivepaisa").delete(synchronize_session=False)
    db_session.commit()
...
def process_5paisa_csv(path):
    ...
    # Create a new DataFrame in Max Algos format
    new_df = pd.DataFrame()
    ...
    # Step 3: Explicit rename map for symbols whose cleaned form differs from Max Algos standard
