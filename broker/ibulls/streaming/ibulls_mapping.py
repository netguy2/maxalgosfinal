...
class IbullsExchangeMapper:
    """Maps between Max Algos exchange codes and Ibulls XTS specific exchange types"""

    # Exchange type mapping for Ibulls XTS broker
    # Format: {Max Algos_Exchange: iBulls_Exchange_Code}
    ...
    # Reverse mapping for converting iBulls exchange codes to Max Algos format
    # Format: {iBulls_Exchange_Code: Max Algos_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert Max Algos exchange code to Ibulls XTS specific exchange type
    ...
    @staticmethod
    def get_maxalgos_exchange(ibulls_code):
        """
        Convert Ibulls XTS exchange code to Max Algos exchange code
