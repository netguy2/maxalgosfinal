...
def transform_margin_positions(positions):
    """
    Transform Max Algos margin position format to Angel Broking margin format.
...
def map_product_type(product):
    """
    Maps Max Algos product type to Angel Broking product type.
...
def map_order_type(pricetype):
    """
    Maps Max Algos price type to Angel Broking order type.

    Max Algos: MARKET, LIMIT, SL, SL-M
...
def parse_margin_response(response_data):
    """
    Parse Angel Broking margin calculator response to Max Algos standard format.
