...
def delete_symtoken_table():
    ...
    SymToken.query.filter(SymToken.broker == "angel").delete(synchronize_session=False)
    db_session.commit()
...
def process_angel_json(path):
    ...
    # and normalize to Max Algos common format (uppercase, no spaces/hyphens)
    ...
    # and normalize to Max Algos common format (uppercase, no spaces/hyphens, remove S&P prefix)
    ...
    # Override for major indices where normalized name differs from Max Algos standard
