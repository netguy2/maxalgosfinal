"""
Complete Dhan WebSocket client wrapper for Max Algos.
...
class DhanWebSocket:
    ...
    Bridges the async implementation with Max Algos's threading model.
    """
    ...
    def _parse_ticker_data(self, packet_data):
        ...
        try:
            ...
            # Create tick dictionary in Max Algos format
            tick = {
                "token": token,
    ...
    def _parse_market_update(self, packet_data):
        ...
        try:
            ...
            tick = {
                ...
                "close": close_price,
                "mode": "QUOTE",
                # Additional fields for Max Algos compatibility
    ...
    def _check_and_send_depth_20(self, token):
        ...
        try:
            ...
            # Format depth data to match the Max Algos standard
            formatted_bids = []
            if data.get("bids"):
            ...
            # Create tick data in Max Algos format with enhanced depth information
            tick = {
                "token": token,
                "instrument_token": token,
                "exchange": exchange,
