...
def transform_margin_positions(positions):
    """
    Transform Max Algos margin positions to Definedge Span Calculator format.
...
def parse_margin_response(response_data):
    """
    Parse Definedge margin response to Max Algos standard format.
    ...
    try:
        ...
        # Return standardized Max Algos format
        return {
            "status": "success",
            "data": {
