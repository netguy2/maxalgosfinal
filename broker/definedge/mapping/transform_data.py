...
def transform_data(data, token_id):
    """Transform Max Algos order data to DefinedGe Securities format"""
    ...
    try:
        ...
        # Map Max Algos fields to DefinedGe fields based on API docs
        transformed_data = {
...
def map_exchange(exchange):
    """Map Max Algos exchange to DefinedGe exchange"""
    exchange_mapping = {
        "NSE": "NSE",
        "BSE": "BSE",
        "NFO": "NFO",
...
def reverse_map_exchange(exchange):
    """Map DefinedGe exchange to Max Algos exchange"""
    reverse_mapping = {
        "NSE": "NSE",
        "BSE": "BSE",
        "NFO": "NFO",
...
def map_product_type(product):
    """Map Max Algos product type to DefinedGe product type"""
    product_mapping = {
        "MIS": "INTRADAY",
        "CNC": "NORMAL",
        "NRML": "NORMAL",
...
def reverse_map_product_type(product):
    """Map DefinedGe product type to Max Algos product type"""
    reverse_mapping = {
        "INTRADAY": "MIS",
...
def map_price_type(pricetype):
    """Map Max Algos price type to DefinedGe price type"""
    price_mapping = {
        "MARKET": "MARKET",
        "LIMIT": "LIMIT",
        "SL": "STOP_LOSS",
...
def map_definedge_price_type(pricetype):
    """Map Max Algos price type to DefinedGe API price type (for modify order)"""
    price_mapping = {"MARKET": "MARKET", "LIMIT": "LIMIT", "SL": "SL-LIMIT", "SL-M": "SL-MARKET"}
    return price_mapping.get(pricetype, "LIMIT")


def map_product_type_for_modify(product):
    """Map Max Algos product type to DefinedGe product type for modify order"""
    product_mapping = {
        "MIS": "INTRADAY",
...
def reverse_map_price_type(pricetype):
    """Map DefinedGe price type to Max Algos price type"""
    reverse_mapping = {
        "MARKET": "MARKET",
        "LIMIT": "LIMIT",
        "STOP_LOSS": "SL",
...
def map_order_status(status):
    """Map DefinedGe order status to Max Algos status"""
    status_mapping = {
        "COMPLETE": "COMPLETE",
        "OPEN": "OPEN",
        "PENDING": "PENDING",
...
def transform_order_data(order):
    """Transform DefinedGe order data to Max Algos format"""
    try:
        transformed_order = {
...
def transform_position_data(position):
    """Transform DefinedGe position data to Max Algos format"""
    try:
...
def transform_holding_data(holding):
    """Transform DefinedGe holding data to Max Algos format"""
    try:
