...
class DefinedgeExchangeMapper:
    """Maps Max Algos exchange codes to DefinEdge-specific exchange types"""
    ...
    def get_exchange_code(exchange):
        """
        Convert Max Algos exchange code to DefinEdge exchange code

        Args:
            exchange (str): Max Algos exchange code
