...
def map_order_data(order_data):
    ...
    Returns:
    - List of mapped orders in Max Algos format
    """
    ...
    for order in orders:
        mapped_order = {}
        # Get Max Algos symbol from token
...
def calculate_order_statistics(order_data):
    ...
    if order_data:
        for order in order_data:
            ...
            # Map price type back to Max Algos canonical form. Tolerant of both
...
def transform_order_data(orders):
    """
    Transform order data to match Max Algos format.
    ...
    # Map Firstock status -> Max Algos canonical status. Firstock returns
    # "CANCELED" (single L) but Max Algos UI expects "cancelled" (double L);
...
def map_trade_data(trade_data):
    ...
    Returns:
    - List of mapped trades in Max Algos format
    """
    # If it's a list, data is already mapped
...
def transform_tradebook_data(trades):
    """
    Transform trade data to match Max Algos format.
...
def map_portfolio_data(portfolio_data):
    ...
    Returns:
    - List of mapped holdings in Max Algos format
    """
...
def transform_holdings_data(holdings):
    """
    Transform holdings data to match Max Algos format.
...
def map_position_data(position_data):
    ...
    Returns:
    - List of mapped positions in Max Algos format
    """
    # If it's a list, data is already mapped
...
def transform_positions_data(positions):
    """
    Transform position data to match Max Algos format.
