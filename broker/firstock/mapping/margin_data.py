...
def _build_order(position, auth_token):
    """Build a single Firstock basketMargin leg from an Max Algos position."""
...
def transform_margin_positions(positions, userid, auth_token=None):
    """
    Transform a list of Max Algos positions into a Firstock basketMargin payload.
...
def parse_margin_response(response_data):
    """
    Parse Firstock /V1/basketMargin response into Max Algos's standard shape.
