...
class CompositedgeExchangeMapper:
    """Maps between Max Algos exchange codes and Compositedge XTS specific exchange types"""

    # Exchange type mapping for Compositedge XTS broker
    # Format: {Max Algos_Exchange: Compositedge_Exchange_Code}
    ...
    # Reverse mapping for converting Compositedge exchange codes to Max Algos format
    # Format: {Compositedge_Exchange_Code: Max Algos_Exchange}
    ...
    def get_exchange_type(exchange):
        """
        Convert Max Algos exchange code to Compositedge XTS specific exchange type
    ...
    @staticmethod
    def get_maxalgos_exchange(compositedge_code):
        """
        Convert Compositedge XTS exchange code to Max Algos exchange code

        Args:
            compositedge_code (int): Compositedge exchange code

        Returns:
            str: Max Algos exchange code
        """
