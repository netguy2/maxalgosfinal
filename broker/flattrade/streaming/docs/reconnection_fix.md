...
This document outlines a critical session management issue identified with the Flattrade WebSocket API and the corresponding architectural fix implemented in the Max Algos proxy.
...
5.  Restarting the main Max Algos application would temporarily resolve the problem, allowing the next connection to succeed.
