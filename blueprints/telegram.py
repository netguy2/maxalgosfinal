...
def send_test_message():
    ...
    try:
        ...
        # Try to find user by maxalgos_username
        telegram_user = None
        for user in all_users:
            if user.get("maxalgos_username") == username:
                telegram_user = user
                break
        ...
        if not telegram_user and all_users:
            ...
            message = f"🔔 Test Message from Max Algos (Admin: {username})\n\nYour Telegram integration is working correctly!"
        elif telegram_user:
            message = (
                "🔔 Test Message from Max Algos\n\nYour Telegram integration is working correctly!"
            )
        else:
            return jsonify(
                {
