...
def load_bruno_endpoints(broker_type="IN_stock"):
    ...
    collections_path = os.path.join(
        os.path.dirname(os.path.dirname(__file__)), "collections", "maxalgos", broker_type
    )
...
def get_collections():
    ...
    postman_path = os.path.join("collections", "postman", "maxalgos.postman_collection.json")
    ...
    bruno_path = os.path.join("collections", "maxalgos_bruno.json")
