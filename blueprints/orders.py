...
def approve_pending_order_route(order_id):
    ...
    if success:
        ...
        # Emit socket event to notify about order approval. room-scoped to
        # the approving user -- the payload already carries their user_id,
        # but as a bare broadcast every OTHER logged-in user's Action
        # Center refreshed and showed this approval too.
        emit_to_user(
