...
Checks file and directory permissions for Max Algos components.
...
def get_permission_checks():
    ...
    # Format: 'sqlite:///db/maxalgos.db' -> 'db/maxalgos.db'
    ...
    main_db = extract_db_path("DATABASE_URL", "db/maxalgos.db")
...
def get_base_path():
    """Get the base path of the Max Algos application."""
