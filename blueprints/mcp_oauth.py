    ...
    return jsonify(
        {
            ...
            "service_documentation": "https://docs.maxalgos.in/remote-mcp",
        }
    )
    ...
    return jsonify(
        {
            ...
            "scopes_supported": _supported_scopes(),
            "resource_documentation": "https://docs.maxalgos.in/remote-mcp",
        }
    )
...
def discovery_protected_resource():
    ...
    a 401 from /mcp. We point back at the same host since Max Algos is
...
<head>
  ...
  <title>Authorize {{ client_name }} — Max Algos</title>
  <style>
...
<body>
  <div class="card">
    ...
    <p>This MCP client is requesting access to your Max Algos install.</p>
