...
def disconnect_broker_connection(broker):
    ...
    # redirecting to the broker's real OAuth login page. Only clear when the
    # disconnected broker IS the session's current broker; disconnecting a
    # different (non-active) broker connection must not log the user out.
