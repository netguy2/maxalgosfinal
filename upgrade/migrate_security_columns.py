...
def migrate_settings_table():
    ...
    if DATABASE_URL.startswith("sqlite:///") and not DATABASE_URL.startswith("sqlite:////"):
        ...
        # Make it relative to parent directory (maxalgos root)
...
def main():
    ...
    logger.info("=" * 60)
    logger.info("Max Algos Security Columns Migration Script")
    logger.info("=" * 60)
    ...
    if success:
        ...
        logger.info("\n📌 Next Steps:")
        logger.info("   1. Restart your Max Algos application")
