#!/usr/bin/env python3
"""
Universal SMTP Migration for Max Algos - With Automatic Path Resolution

This script adds SMTP configuration columns to the Max Algos database.
...
Examples:
  ...
  uv run migrate_smtp_universal_path.py --verbose   # Run with uv from anywhere
    ...
    safe_print("🚀 Max Algos SMTP Migration (Universal Path Version)", use_emoji)
    safe_print("=" * 50, False)
    ...
    try:
        ...
        if success:
            ...
            if verify_smtp_columns():
                ...
                safe_print("\nNext steps:", False)
                safe_print("1. Restart your Max Algos application", False)
