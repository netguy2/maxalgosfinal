"""
Max Algos REST API benchmark.

Usage (key from env, not hardcoded):
    MAX_ALGOS_APIKEY=xxxx python benchmark_api.py
...
BASE = os.getenv("MAX_ALGOS_BASE", "http://127.0.0.1:5000/api/v1")
APIKEY = os.environ["MAX_ALGOS_APIKEY"]
...
print("=" * 74)
print(f"Max Algos API benchmark   base={BASE}   key=...{APIKEY[-6:]}")
