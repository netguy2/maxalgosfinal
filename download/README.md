...
This tool allows you to download Intraday End of Day (IEOD) data for specified stock symbols from the Max Algos API.

## Prerequisites

- Python 3.x
- Valid Max Algos API key
- Access to Max Algos API endpoint (ensure maxalgos is running)
...
1. Ensure you have a valid API key from Max Algos
