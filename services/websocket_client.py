"""
Internal WebSocket client wrapper for connecting to the Max Algos WebSocket server.
...
class WebSocketClient:
    """
    Internal WebSocket client for connecting to Max Algos WebSocket server.
