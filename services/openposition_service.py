...
def _emit_analyzer_update(payload: dict[str, Any], api_key: str | None) -> None:
    ...
    Was a bare broadcast -- see the identical helper in
    services/orderstatus_service.py for the full rationale. Unresolvable
    api_key -> dropped, never broadcast.
    """
...
def get_open_position_with_auth(
    ...
    if get_analyze_mode():
        ...
        # Emit SocketIO event asynchronously (non-blocking), scoped to the caller
        _emit_analyzer_update(
