...
def split_order_with_auth(
    ...
    if not allowed:
        ...
        # error alone would block the split silently from the user's view.
        bus.publish(OrderFailedEvent(
            mode="live",
            api_type="splitorder",
            request_data=split_request_data,
