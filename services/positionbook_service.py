...
def get_positionbook(
    ...
    Args:
        ...
        requested_broker: On the API-key path, pin the lookup to this SPECIFIC
            one of the caller's connected brokers instead of whichever is
            their primary Auth session. Same override mechanism
            place_order_service.py's Case 1 already uses via order_data["broker"].
