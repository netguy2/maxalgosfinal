...
Three tables, all in db/maxalgos.db. Hashing pipeline is identical to the
...
# alongside users in db/maxalgos.db. No new secret material is introduced.
...
def init_db() -> None:
    ...
    logger.info("Initializing OAuth tables in db/maxalgos.db ...")
