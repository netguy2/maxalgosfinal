...
TELEGRAM_KEY_SALT = os.getenv("TELEGRAM_KEY_SALT", "telegram-maxalgos-salt").encode()
...
class TelegramUser(Base):
    ...
    host_url = Column(String(500))  # Max Algos host URL
...
def get_telegram_user_by_username(username: str) -> dict | None:
    """Get telegram user by Max Algos username (cached for 30 minutes)"""
