# Max Algos Advanced Docker Installation (Multi-Instance & Custom SSL)
...
- **Multiple Max Algos instances** on a single server.
...
1.  **Instance Name**:
    ...
    - This allows you to run multiple independent copies of Max Algos side-by-side.
...
```
/opt/
  ├── maxalgos-algo1/       # Instance 1
  │   ├── docker-compose.yaml
  │   └── .env
  └── maxalgos-fyers-bot/   # Instance 2 (Different Broker/Strategy)
      ├── docker-compose.yaml
      └── .env
```
