...
This strategy demonstrates how to integrate with Max Algos API
"""
...
# When this strategy is launched via Max Algos's /python runner,
# MAX_ALGOS_API_KEY is injected by the platform and HOST_SERVER /
# WEBSOCKET_URL are inherited from Max Algos's .env file.
...
def ema_strategy():
    ...
    while True:
        try:
            ...
            # Fetch 1-minute historical data using Max Algos
            df = client.history(
                symbol=symbol,
                exchange=exchange,
                interval="1m",
