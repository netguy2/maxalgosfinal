"""
Max Algos WebSocket LTP Example - 1800 Symbols Test
...
# Add parent directory to path to import maxalgos
...
try:
    ...
    print("Error: Could not import maxalgos. Make sure you're running from the correct directory.")
    sys.exit(1)
...
def main():
    print("Max Algos WebSocket LTP Example - 1800 Symbols Test")
    print("=" * 60)
