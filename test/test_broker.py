#!/usr/bin/env python3
"""
Max Algos – New Broker Integration Test
...
# ───────────────── CONFIG ─────────────────
API_KEY = os.getenv(
    "MAX_ALGOS_API_KEY", "3bb8d260915ff680a7258108c0483b9eb7675ced31309a36f5846366943ee9fa"
)
...
if __name__ == "__main__":
    try:
        from maxalgos import api as OAClient
    except ImportError:
        print(red("maxalgos SDK missing – pip install maxalgos"))
        sys.exit(1)
