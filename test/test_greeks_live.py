...
Tests the /api/v1/multioptiongreeks endpoint against a running Max Algos
instance with any connected broker.

Prerequisites:
    1. Max Algos must be running at http://127.0.0.1:5000
...
if __name__ == "__main__":
    ...
    if not atm:
        print("  FATAL: Cannot fetch LTP. Is Max Algos running and broker connected?")
        sys.exit(1)
