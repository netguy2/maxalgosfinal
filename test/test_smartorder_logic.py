...
Usage:
    cd /Users/maxalgos/maxalgos-test/maxalgos
...
# ---------------------------------------------------------------------------
# Test data: the Max Algos SmartOrder spec table
# ---------------------------------------------------------------------------
...
class TestSmartOrderPositionLogic:
    """Test the position calculation logic against the Max Algos spec table."""
