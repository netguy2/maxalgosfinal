...
1. Enable **Analyze Mode** in Max Algos settings
2. Run the tests
...
1. Disable **Analyze Mode** in Max Algos settings
2. Run the tests
...
**Solution**: Make sure Max Algos is running at `http://127.0.0.1:5000`
...
{
  "status": "error",
  "message": "Invalid maxalgos apikey"
}
```

**Solution**: Replace API key in test file with your actual API key from Max Algos settings
...
- Check Max Algos logs for detailed error messages
