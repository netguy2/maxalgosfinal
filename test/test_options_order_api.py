...
Make sure the Max Algos application is running before executing this script.
...
# Add parent directory to path so we can import from maxalgos modules if needed
...
if __name__ == "__main__":
    print("\n" + "=" * 60)
    print("Max Algos Options Order API Test Suite")
    print("=" * 60)
    print(f"\nBase URL: {BASE_URL}")
