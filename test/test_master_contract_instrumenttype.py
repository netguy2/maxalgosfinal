...
if not os.getenv("DATABASE_URL"):
    db_path = os.path.join(
        os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "db", "maxalgos.db"
    )
...
def main():
    ...
    try:
        ...
        print(
            yellow("Make sure Max Algos is properly configured and master contracts are downloaded.")
        )
        return 1
