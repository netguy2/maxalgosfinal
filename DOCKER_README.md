# Max Algos - Algorithmic Trading Platform

Max Algos is a production-ready algorithmic trading platform providing a unified API layer across 24+ Indian brokers. Seamlessly integrate with TradingView, Amibroker, Excel, Python, and AI agents.
...
- **Full Docs**: https://docs.maxalgos.in
- **Installation Guide**: https://github.com/marketcalls/maxalgos/blob/main/install/Docker-install-readme.md
- **GitHub**: https://github.com/marketcalls/maxalgos

## Community

- **Discord**: https://discord.com/invite/UPh7QPsNhP
- **YouTube**: https://youtube.com/@maxalgosHQ
