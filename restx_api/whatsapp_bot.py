...
notify_model = api.model(
    "WhatsAppNotification",
    {
        ...
        "username": fields.String(
            description="Max Algos username — resolves to that user's linked WhatsApp number."
        ),
        "phone": fields.String(
...
class WhatsAppNotify(Resource):
    ...
    def post(self):
        ...
        Recipient (exactly one of):
            ...
            "username": "<maxalgos>"    — resolve via linked-users table
                ...
                jsonify(
                    {
                        ...
                        "message": (
                            ...
                            "first from the /whatsapp page in Max Algos before sending."
                        ),
                    }
                ),
