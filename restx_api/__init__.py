...
api = Api(
    ...
    version="1.0",
    title="Max Algos API",
    description="API for Max Algos Trading Platform",
    doc=False,
)
...
from .basket_order_multi import api as basket_order_multi_ns
...
from .orderbook_multi import api as orderbook_multi_ns
...
from .place_order_multi import api as place_order_multi_ns
...
api.add_namespace(place_order_multi_ns, path="/placeordermulti")
...
api.add_namespace(orderbook_multi_ns, path="/orderbookmulti")
...
api.add_namespace(basket_order_multi_ns, path="/basketordermulti")
