...
Before installing Max Algos, ensure you have the following prerequisites installed:
...
2. **Clone the Repository**: 
   Open the VS Code Terminal and clone the Max Algos repository:
   ```bash
...
5. **Configure Environment Variables**: 
   - Rename `.sample.env` to `.env` in the `maxalgos` folder
...
For more detailed configuration instructions, visit [https://docs.maxalgos.in](https://docs.maxalgos.in)
