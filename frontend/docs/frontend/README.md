# Max Algos Frontend Documentation

Welcome to the Max Algos React frontend documentation. This guide covers everything you need to know to develop, test, and maintain the frontend application.
...
Max Algos frontend is a single-page application (SPA) that provides:
