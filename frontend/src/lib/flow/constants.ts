...
export const NODE_DEFINITIONS = {
  ...
  ACTIONS: [
    ...
    },
    {
      type: 'basketClose',
      label: 'Basket Close',
      description: 'Square off only a specified basket of positions',
      category: 'action' as const,
    },
  ],
  ...
  CONDITIONS: [
    ...
    },
    {
      ...
      description: 'Check combined P&L across a basket of positions',
      category: 'condition' as const,
    },
    {
      type: 'fundCheck',
    ...
    },
    {
      ...
      description: 'RSI, EMA, SMA, MACD, ATR, VWAP condition',
      category: 'condition' as const,
    },
    {
      type: 'timeWindow',
