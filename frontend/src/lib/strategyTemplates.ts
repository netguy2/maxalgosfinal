...
export const STRATEGY_TEMPLATES: StrategyTemplate[] = [
  ...
  },
  {
    ...
    direction: 'BULLISH',
    description:
      'Bull call spread + an extra short OTM call further out. Reduces (or removes) the net debit versus a plain bull call spread, at the cost of unlimited loss if spot rallies past the third strike.',
    legs: [
      { side: 'BUY', optionType: 'CE', strikeOffset: 0, lots: 1 },
      { side: 'SELL', optionType: 'CE', strikeOffset: 2, lots: 1 },
      { side: 'SELL', optionType: 'CE', strikeOffset: 4, lots: 1 },
    ],
    payoffPath: 'M0,28 L45,28 L60,6 L80,6 L100,30',
  },
  {
    id: 'bullish_seagull',
    ...
    direction: 'BULLISH',
    description:
      'Sell OTM put + buy ATM call + sell further OTM call. Three-leg collar-style structure that finances most of the long call premium; downside is a short put (assignment risk), upside capped by the short call.',
    legs: [
      { side: 'SELL', optionType: 'PE', strikeOffset: -2, lots: 1 },
      { side: 'BUY', optionType: 'CE', strikeOffset: 0, lots: 1 },
      { side: 'SELL', optionType: 'CE', strikeOffset: 3, lots: 1 },
    ],
    payoffPath: 'M0,38 L30,22 L55,22 L75,4 L100,4',
  },
  {
    id: 'broken_wing_butterfly_call',
    name: 'Broken Wing Butterfly (Call)',
    direction: 'BULLISH',
    description:
      'Call butterfly with an asymmetric wing — the upper wing is set further out than the lower, turning the usual defined-risk-both-sides butterfly into a bullish-skewed structure with no downside risk (often a small credit) and capped, limited upside risk.',
    legs: [
      { side: 'BUY', optionType: 'CE', strikeOffset: 0, lots: 1 },
      { side: 'SELL', optionType: 'CE', strikeOffset: 2, lots: 2 },
      { side: 'BUY', optionType: 'CE', strikeOffset: 5, lots: 1 },
    ],
    payoffPath: 'M0,22 L50,22 L65,4 L80,22 L100,16',
  },
  ...
  },
  {
    ...
    direction: 'BEARISH',
    description:
      'Bear put spread + an extra short OTM put further out. Reduces (or removes) the net debit versus a plain bear put spread, at the cost of unlimited loss if spot falls past the third strike.',
    legs: [
      { side: 'BUY', optionType: 'PE', strikeOffset: 0, lots: 1 },
      { side: 'SELL', optionType: 'PE', strikeOffset: -2, lots: 1 },
      { side: 'SELL', optionType: 'PE', strikeOffset: -4, lots: 1 },
    ],
    payoffPath: 'M0,30 L20,6 L40,6 L55,28 L100,28',
  },
  {
    id: 'bearish_seagull',
    ...
    direction: 'BEARISH',
    description:
      'Sell OTM call + buy ATM put + sell further OTM put. Three-leg collar-style structure that finances most of the long put premium; upside is a short call (assignment risk), downside capped by the short put.',
    legs: [
      { side: 'SELL', optionType: 'CE', strikeOffset: 2, lots: 1 },
      { side: 'BUY', optionType: 'PE', strikeOffset: 0, lots: 1 },
      { side: 'SELL', optionType: 'PE', strikeOffset: -3, lots: 1 },
    ],
    payoffPath: 'M0,4 L25,4 L45,22 L70,22 L100,38',
  },
  {
    id: 'broken_wing_butterfly_put',
    name: 'Broken Wing Butterfly (Put)',
    direction: 'BEARISH',
    description:
      'Put butterfly with an asymmetric wing — the lower wing is set further out than the upper, turning the usual defined-risk-both-sides butterfly into a bearish-skewed structure with no upside risk (often a small credit) and capped, limited downside risk.',
    legs: [
      { side: 'BUY', optionType: 'PE', strikeOffset: 0, lots: 1 },
      { side: 'SELL', optionType: 'PE', strikeOffset: -2, lots: 2 },
      { side: 'BUY', optionType: 'PE', strikeOffset: -5, lots: 1 },
    ],
    payoffPath: 'M0,16 L20,22 L35,4 L50,22 L100,22',
  },
