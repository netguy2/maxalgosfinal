...
export default function OIProfile() {
  ...
  // Theme colors — derived from active theme tokens; alpha suffixes are
  ...
  const themeColors = useMemo(
    () => ({
      ...
      ceOI: chartTheme.profit,
      peOI: chartTheme.loss,
      ceChange: `${chartTheme.profit}80`,
      peChange: `${chartTheme.loss}80`,
      atmLine: chartTheme.brand,
      hoverBg: chartTheme.card,
      hoverFont: chartTheme.foreground,
      hoverBorder: chartTheme.border,
      increasing: chartTheme.profit,
      decreasing: chartTheme.loss,
    }),
    [chartTheme]
  )
