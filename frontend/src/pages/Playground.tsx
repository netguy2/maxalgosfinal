      ...
      <div className="h-12 border-b border-border flex items-center px-2 bg-card/50">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-2 px-2">
            <img src="/images/android-chrome-192x192.png" alt="Max Algos" className="w-6 h-6" />
            <span className="font-semibold text-sm">maxalgos</span>
          </div>
        </div>
              ...
              {activeTab ? (
                <>
                  ...
                  <div className="flex items-center gap-2 px-4 py-2 border-b border-border bg-card/30">
                    ...
                    <Button
                      size="sm"
                      className="h-8 px-4 bg-profit hover:bg-profit text-white"
                      onClick={sendRequest}
                      disabled={isLoading}
                    >
                      {isLoading ? (
