...
export default function AdminIndex() {
  ...
  const adminCards = [
    ...
    },
    {
      ...
      description: 'Create, view and manage platform user accounts',
      icon: Users,
      href: '/admin/users',
      countLabel: 'accounts',
      color: 'bg-loss',
    },
    {
      ...
      description: 'Configure the Razorpay setup fee, marketplace pricing, and payment log',
      icon: CreditCard,
      href: '/admin/payments',
      countLabel: 'billing',
      color: 'bg-profit',
    },
    {
      ...
      description: 'Configure SMTP for signup verification and password-reset emails',
      icon: Mail,
      href: '/admin/email',
      countLabel: 'SMTP',
      color: 'bg-info',
