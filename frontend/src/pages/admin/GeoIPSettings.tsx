    ...
    <div className="space-y-8 max-w-3xl mx-auto pb-10">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-xl font-bold text-foreground tracking-tight">GeoIP Settings</h1>
          <p className="text-sm text-muted-foreground mt-0.5">
            Configure MaxMind GeoLite2 for city/country/ISP lookup on the Active Sessions dashboard
          </p>
        </div>
        <button
          type="button"
