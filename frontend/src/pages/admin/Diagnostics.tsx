  ...
  return (
    <div className="py-6 space-y-6">
      ...
      <p className="text-sm text-muted-foreground">
        ...
        the Max Algos community — secrets and tokens are never included.
      </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Section icon={Settings} title="Build">
          <div>
            <KV label="Max Algos" value={info?.build.maxalgos_version} />
            <KV label="Max Algos SDK" value={info?.build.maxalgos_sdk_version} />
