...
export default function RemoteMcp() {
  ...
  const handleSaveSettings = async () => {
    ...
    try {
      ...
      showToast.success('Saved. Restart the maxalgos service to apply.', 'admin')
    } catch (err: unknown) {
      const msg =
            ...
            <div className="flex items-center justify-between flex-wrap gap-3">
              <div>
                ...
                <CardDescription>
                  ...
                  <code className="mx-1">.env</code>; the maxalgos service must be restarted before
                  they take effect.
                </CardDescription>
              </div>
          ...
          <CardContent className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-xs text-muted-foreground">
                Same as your Max Algos dashboard URL. Required when MCP is enabled. Used as the JWT
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <div className="text-3xl font-bold text-profit">{summary.approved}</div>
