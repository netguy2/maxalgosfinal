...
export default function CustomStraddle() {
  ...
  // Theme colors — all derive from active theme tokens; alpha suffixes are
  // appended to the opaque hex values returned by useChartTheme.
  const colors = useMemo(
    () => ({
      ...
      spot: chartTheme.foreground,
      profitLine: chartTheme.profit,
      profitFill1: `${chartTheme.profit}47`,
      profitFill2: `${chartTheme.profit}0d`,
      lossLine: chartTheme.loss,
      lossFill1: `${chartTheme.loss}0d`,
      lossFill2: `${chartTheme.loss}47`,
      watermark: `${chartTheme.mutedForeground}1f`,
      synthetic: chartTheme.buy,
    ...
    <PageContainer spacing="none">
      <Card>
        <CardHeader className="pb-4 flex flex-row items-center justify-between">
          ...
          <DocsLink page="custom-straddle" iconOnly />
        </CardHeader>
        <CardContent>
