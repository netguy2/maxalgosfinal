...
export default function VolSurface() {
  ...
  // Theme colors — chrome derives from tokens; the 3D surface colorscale is
  // a named Plotly scale picked per mode (tokens can't express a gradient).
