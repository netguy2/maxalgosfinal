...
export default function ViewStrategy() {
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="mt-1">{getSignalSourceLabel(strategy.platform)}</p>
              </div>
            </div>
  ...
  "signal": "BUY"
                ...
                <p className="text-xs text-muted-foreground">
                  Use BUY, SELL, EXIT, SHORT, or COVER for the signal field (decoupled from symbol
                  mappings).
                </p>
              </div>
            )}
      ...
      <Alert>
        ...
        <AlertDescription>
          <ul className="list-disc list-inside mt-2 space-y-1 text-sm">
            ...
            <li>
              Each symbol's own <strong>React to Signal</strong> setting (in Configure Symbols)
              decides which incoming signal it reacts to — set it to BOTH to react to either
            </li>
          </ul>
        </AlertDescription>
      </Alert>
