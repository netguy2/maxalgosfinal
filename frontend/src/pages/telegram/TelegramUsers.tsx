    ...
    if (searchQuery) {
      const filtered = users.filter(
        (user) =>
          ...
          user.maxalgos_username?.toLowerCase().includes(searchQuery.toLowerCase()) ||
  ...
  return (
    <div className="py-6 space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <Card>
          <CardContent className="p-4 text-center">
            <p className="text-2xl font-bold">{users.filter((u) => u.maxalgos_username).length}</p>
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead>Max Algos Account</TableHead>
                ...
                {filteredUsers.length === 0 ? (
                  ...
                  filteredUsers.map((user) => (
                    <TableRow key={user.telegram_id}>
                      ...
                      <TableCell>
                        {user.maxalgos_username ? (
                          <Badge variant="outline">{user.maxalgos_username}</Badge>
                        ) : (
                      ...
                      <TableCell>
                        {user.notifications_enabled ? (
                          <Badge className="bg-profit hover:bg-profit">
