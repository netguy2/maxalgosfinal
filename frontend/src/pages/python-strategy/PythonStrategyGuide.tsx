...
Run via Max Algos's /python strategy runner:
    MAX_ALGOS_API_KEY            : injected per-strategy (PR #1247).
    MAX_ALGOS_STRATEGY_EXCHANGE  : set from the strategy's \`exchange\` config
    ...
    HOST_SERVER / WEBSOCKET_URL : inherited from Max Algos's .env.
...
# When launched via Max Algos's /python runner, these come from the platform:
#   MAX_ALGOS_API_KEY : injected per-strategy (decrypted from DB)
#   HOST_SERVER      : inherited from Max Algos's .env
#   WEBSOCKET_URL    : inherited from Max Algos's .env
...
# Trade Settings
# EXCHANGE prefers MAX_ALGOS_STRATEGY_EXCHANGE (set by /python runner from the
...
class ConfigurableEMABot:
    ...
    def ltp_polling_thread(self):
        """Poll LTP every second for SL/target monitoring."""
        while not self.stop_event.is_set():
            try:
                ltp = self.client.ltp(SYMBOL, EXCHANGE)
                if ltp and ltp > 0:
                    self.ltp = ltp
                    if self.position and not self.exit_in_progress:
                        self._check_sl_target(ltp)
            except Exception as e:
                print(f"[ERROR] LTP poll error: {e}")
            time.sleep(1)
    ...
    def run(self):
        # Start LTP polling thread for real-time SL/Target monitoring
        poll_thread = threading.Thread(target=self.ltp_polling_thread, daemon=True)
        poll_thread.start()
        time.sleep(1)
...
# Exchange — reads MAX_ALGOS_STRATEGY_EXCHANGE so your script
...
export default function PythonStrategyGuide() {
  return (
    <PageContainer>
              ...
              <div>
                ...
                <div className="mt-1 flex items-center gap-2">
                  ...
                  <Button
                    variant="ghost"
                    size="sm"
                    onClick={() => copyToClipboard('from maxalgos import api')}
                  >
                    Copy
                  </Button>
                </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  ...
                  page and copy your Max Algos API key
                </p>
              </div>
            </div>
            <div className="flex gap-4">
        ...
        <CardContent className="space-y-4 text-sm">
          <div className="space-y-3">
            ...
            <div className="bg-muted p-3 rounded-lg">
              ...
              <p className="text-muted-foreground">
                The host injects <code>MAX_ALGOS_API_KEY</code>, <code>STRATEGY_ID</code>,{' '}
                <code>STRATEGY_NAME</code>, and <code>MAX_ALGOS_STRATEGY_EXCHANGE</code> into each
      ...
      <Card>
        ...
        <CardContent className="space-y-5">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm border-collapse">
                ...
                <tbody className="text-muted-foreground">
                  ...
                  <tr className="border-b">
                    <td className="py-2 pr-4">
                      <code>MAX_ALGOS_STRATEGY_EXCHANGE</code>
                    </td>
                    <td className="py-2">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-3">
              Strategies inherit every variable from Max Algos's <code>.env</code> via{' '}
              <code>os.environ.copy()</code>. The key ones for connecting back to Max Algos:
            </p>
            <div className="overflow-x-auto">
              <table className="w-full text-sm border-collapse">
                <thead>
                ...
                <tbody className="text-muted-foreground">
                  ...
                  <tr className="border-b">
                    ...
                    <td className="py-2">
                      Full WebSocket URL, e.g. <code>ws://127.0.0.1:8785</code>
                    </td>
                  </tr>
                  <tr className="border-b">
                    <td className="py-2 pr-4">
                  ...
                  <tr className="border-b">
                    ...
                    <td className="py-2">
                      WebSocket port, e.g. <code>8785</code>
                    </td>
                  </tr>
                  <tr className="border-b">
                    <td className="py-2 pr-4">
          ...
          <Alert>
            <AlertTitle>Reading MAX_ALGOS_STRATEGY_EXCHANGE is strongly recommended</AlertTitle>
            <AlertDescription>
        ...
        <CardContent>
          <Accordion type="single" collapsible className="w-full">
              ...
              <AccordionContent className="text-muted-foreground space-y-3">
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-3 p-2 bg-muted rounded">
                    <Badge className="bg-profit text-white">Running</Badge>
                  ...
                  <div className="flex items-center gap-3 p-2 bg-muted rounded">
                    <Badge className="bg-warning text-white">Paused</Badge>
                    <span className="text-sm">
                      Strategy is paused due to market holiday for its exchange
                    </span>
                  </div>
                  <div className="flex items-center gap-3 p-2 bg-muted rounded">
                    <Badge className="bg-loss text-white">Error</Badge>
            ...
            <AccordionItem value="start-stop">
              ...
              <AccordionContent className="text-muted-foreground space-y-3">
                <div className="bg-profit/10 border border-profit/20 p-3 rounded-lg">
                  <p className="font-medium text-profit">Start Button</p>
                ...
                <div className="bg-loss/10 border border-loss/20 p-3 rounded-lg">
                  <p className="font-medium text-loss">Stop Button (when running)</p>
                  <ul className="list-disc list-inside space-y-1 ml-2 mt-2 text-sm">
              ...
              <AccordionContent className="text-muted-foreground space-y-3">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="bg-muted p-3 rounded-lg">
                    ...
                    <p className="mt-1">
                      Log in to Max Algos before the session, wait for master contracts to download,
            ...
            <AccordionItem value="resource-limits">
              ...
              <AccordionContent className="text-muted-foreground space-y-3">
                <p>
                  ...
                  Max Algos. On Windows, these are not enforced at the OS level.
                </p>
                <div className="overflow-x-auto">
                  <table className="w-full text-sm border-collapse">
                    <thead>
            ...
            <AccordionItem value="restart">
              <AccordionTrigger>What happens if I restart Max Algos?</AccordionTrigger>
              <AccordionContent className="text-muted-foreground space-y-3">
                <p>Max Algos handles restarts gracefully:</p>
                <ul className="list-disc list-inside space-y-1 ml-2">
            ...
            <AccordionItem value="best-practices">
              ...
              <AccordionContent className="text-muted-foreground space-y-2">
                <ul className="list-disc list-inside space-y-2 ml-2">
                  ...
                  <li>
                    <strong>Read MAX_ALGOS_STRATEGY_EXCHANGE</strong> &mdash; Wire the exchange from
            ...
            <AccordionItem value="add-libraries">
              ...
              <AccordionContent className="text-muted-foreground space-y-3">
                <p>
                  If your strategy needs additional Python libraries, install them in Max Algos's
                  environment.
                </p>
                ...
                <div className="space-y-4">
                  <div className="bg-muted p-3 rounded-lg">
                    ...
                    <ol className="list-decimal list-inside space-y-1 ml-2 text-sm">
                      ...
                      <li>
                        Run <code>uv sync</code> in the maxalgos directory
                      </li>
                      <li>Restart Max Algos</li>
                    </ol>
                  </div>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="bg-muted p-3 rounded-lg">
                    ...
                    <p className="mt-1">
                      ...
                      <code>exchange="MCX"</code>. Read <code>MAX_ALGOS_STRATEGY_EXCHANGE</code> in
                  ...
                  <div className="bg-muted p-3 rounded-lg">
                    <p className="font-medium">MAX_ALGOS_API_KEY not set</p>
                    <p className="mt-1">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Max Algos SDK Quick Reference</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
