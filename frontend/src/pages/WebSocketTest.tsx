    ...
    <div className="relative">
      <div
        className={cn(
          ...
          status === 'success' && 'bg-profit shadow-[0_0_8px_rgba(52,211,153,0.8)]',
          status === 'warning' && 'bg-warning shadow-[0_0_8px] shadow-warning/80',
          status === 'error' && 'bg-loss shadow-[0_0_8px_rgba(251,113,133,0.8)]',
      ...
      <div className="absolute inset-0 rounded overflow-hidden">
        <div
          className={cn(
            ...
            side === 'buy'
              ? 'left-0 bg-gradient-to-r from-profit/20 to-transparent'
              : 'right-0 bg-gradient-to-l from-loss/20 to-transparent'
          )}
          style={{ width: `${pct}%` }}
        />
      </div>
          ...
          <div className="rounded-xl bg-card border border-border p-5">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Button
                ...
                disabled={!isConnected}
                size="sm"
                className="border-loss/30 text-loss hover:bg-loss/10 disabled:opacity-30"
              >
                    ...
                    {(isExpanded || hasLtp) && (
                      <div className="grid grid-cols-5 gap-2 mb-4">
                        {[
                          ...
                          { label: 'High', value: symbolData.data.high, color: 'text-profit' },
                          { label: 'Low', value: symbolData.data.low, color: 'text-loss' },
                      ...
                      <div>
                        ...
                        {isDepthExpanded && (
                          <div className="grid grid-cols-2 gap-4 p-3 bg-muted/30 rounded-lg border border-border/40 max-h-[400px] overflow-y-auto">
                            <div>
                              <div className="text-[9px] uppercase tracking-wider text-profit mb-2 flex items-center gap-1 sticky top-0 bg-muted/30 py-1">
                            ...
                            <div>
                              <div className="text-[9px] uppercase tracking-wider text-loss mb-2 flex items-center gap-1 sticky top-0 bg-muted/30 py-1">
