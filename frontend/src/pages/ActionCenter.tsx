  ...
  return (
    <PageContainer>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-5 gap-4">
        ...
        <Card>
          <CardContent className="p-4 text-center">
            <p className="text-2xl font-bold text-profit">{stats.total_buy_orders}</p>
            <p className="text-sm text-muted-foreground">Buy Orders</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4 text-center">
            <p className="text-2xl font-bold text-loss">{stats.total_sell_orders}</p>
            <p className="text-sm text-muted-foreground">Sell Orders</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4 text-center">
            <p className="text-2xl font-bold text-profit">{stats.total_approved}</p>
            <p className="text-sm text-muted-foreground">Approved</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4 text-center">
            <p className="text-2xl font-bold text-loss">{stats.total_rejected}</p>
                          ...
                          <div className="flex gap-1 flex-wrap">
                            ...
                            {order.status === 'pending' ? (
                              <>
                                <Button
                                  size="sm"
                                  className="bg-profit hover:bg-profit h-8"
