    ...
    >
      ...
      <span
        className={cn(
          ...
          side === 'ce' ? 'bg-profit/10 text-profit' : 'bg-loss/10 text-loss'
        )}
      >
        {side === 'ce' ? 'CE' : 'PE'}
      </span>
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent size="default">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <h4 className="text-sm font-medium mb-2 text-profit">CALLS (CE)</h4>
          ...
          <div>
            <h4 className="text-sm font-medium mb-2 text-loss">PUTS (PE)</h4>
            <ScrollArea className="h-64 pr-2">
              <div className="space-y-1.5">
                {peColumns.map((key) => (
                  <DraggableColumn
