  ...
  return (
    <AlertDialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          // max-h + overflow: an alert dialog with a long body (e.g. a
          // square-off confirmation listing every open position) otherwise
          // grows past the viewport and takes its action buttons with it,
          // leaving no way to confirm or cancel. 100dvh so mobile browser
