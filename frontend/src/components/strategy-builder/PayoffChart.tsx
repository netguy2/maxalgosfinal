...
export function PayoffChart({
  ...
  // All colors derive from the active theme tokens; alpha suffixes are
  // appended to the opaque hex values returned by useChartTheme.
  const colors = useMemo(
    () => ({
      paper: chartTheme.background,
      bg: chartTheme.card,
      text: chartTheme.foreground,
      mutedText: chartTheme.mutedForeground,
      grid: `${chartTheme.mutedForeground}2e`,
      profit: `${chartTheme.profit}38`,
      loss: `${chartTheme.loss}38`,
      expiryLine: chartTheme.sell,
      tplus0Line: chartTheme.buy,
      zeroLine: `${chartTheme.foreground}80`,
      spotLine: chartTheme.brand,
      // Stepped σ bands: inner ±1σ darker, outer ±2σ lighter.
      sigma1Band: `${chartTheme.mutedForeground}38`,
      sigma2Band: `${chartTheme.mutedForeground}1a`,
      sigmaTick: `${chartTheme.foreground}59`,
    }),
    [chartTheme]
  )
  ...
  }, [payoff, spot, atmIv, tYears, showTplus0, title, colors])
