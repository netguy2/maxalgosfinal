...
export function NodePalette({ onDragStart }: NodePaletteProps) {
  ...
  const actions = [
    ...
    },
    {
      ...
      icon: <XCircle className="h-3.5 w-3.5 text-loss" />,
      color: 'bg-loss/10',
    },
    {
    ...
    },
    {
      ...
      icon: <Square className="h-3.5 w-3.5 text-loss" />,
      color: 'bg-loss/10',
    },
    {
      type: 'basketClose',
      label: 'Basket Close',
      description: 'Square off a basket',
      icon: <Target className="h-3.5 w-3.5 text-loss" />,
      color: 'bg-loss/10',
    },
  ]
  ...
  const conditions = [
    ...
    {
      type: 'basketPnlCheck',
      label: 'Master SL / Target',
      description: 'Combined P&L across a basket',
      icon: <Target className="h-3.5 w-3.5 text-node-condition" />,
      color: 'bg-node-condition/10',
    },
    {
      type: 'fundCheck',
    ...
    },
    {
      ...
      description: 'RSI, EMA, MACD & more',
      icon: <Activity className="h-3.5 w-3.5 text-node-condition" />,
      color: 'bg-node-condition/10',
    },
    {
      type: 'timeWindow',
  ...
  const data = [
    {
      ...
      icon: <BarChart3 className="h-3.5 w-3.5 text-cat-3" />,
      color: 'bg-cat-3/10',
    },
    {
      type: 'getDepth',
      ...
      icon: <Layers3 className="h-3.5 w-3.5 text-cat-3" />,
      color: 'bg-cat-3/10',
    },
    {
      type: 'getOrderStatus',
      ...
      icon: <FileSearch className="h-3.5 w-3.5 text-node-trigger" />,
      color: 'bg-node-trigger/10',
    },
    {
      type: 'history',
      ...
      icon: <TrendingUp className="h-3.5 w-3.5 text-cat-3" />,
      color: 'bg-cat-3/10',
    },
    {
      type: 'openPosition',
      ...
      icon: <Briefcase className="h-3.5 w-3.5 text-cat-2" />,
      color: 'bg-cat-2/10',
    },
    {
      type: 'expiry',
      ...
      icon: <Calendar className="h-3.5 w-3.5 text-cat-4" />,
      color: 'bg-cat-4/10',
    },
    {
      type: 'multiQuotes',
    ...
    },
    {
      ...
      icon: <Tag className="h-3.5 w-3.5 text-cat-5" />,
      color: 'bg-cat-5/10',
    },
    {
      type: 'optionSymbol',
      ...
      icon: <Target className="h-3.5 w-3.5 text-cat-4" />,
      color: 'bg-cat-4/10',
    },
    {
      type: 'orderBook',
      ...
      icon: <ClipboardList className="h-3.5 w-3.5 text-node-trigger" />,
      color: 'bg-node-trigger/10',
    },
    {
      type: 'tradeBook',
      ...
      icon: <Receipt className="h-3.5 w-3.5 text-node-trigger" />,
      color: 'bg-node-trigger/10',
    },
    {
      type: 'positionBook',
    ...
    },
    {
      ...
      icon: <Calculator className="h-3.5 w-3.5 text-cat-4" />,
      color: 'bg-cat-4/10',
    },
    {
      type: 'optionChain',
      ...
      icon: <Grid3X3 className="h-3.5 w-3.5 text-cat-4" />,
      color: 'bg-cat-4/10',
    },
    {
      type: 'holdings',
      ...
      icon: <Briefcase className="h-3.5 w-3.5 text-warning" />,
      color: 'bg-warning/10',
    },
    {
      type: 'funds',
  ...
  const streaming = [
    {
      ...
      icon: <Radio className="h-3.5 w-3.5 text-profit" />,
      color: 'bg-profit/10',
    },
    {
      type: 'subscribeQuote',
      ...
      icon: <RadioTower className="h-3.5 w-3.5 text-profit" />,
      color: 'bg-profit/10',
    },
    {
      type: 'subscribeDepth',
      ...
      icon: <Layers3 className="h-3.5 w-3.5 text-profit" />,
      color: 'bg-profit/10',
    },
    {
      type: 'unsubscribe',
  ...
  const utilities = [
    {
      ...
      icon: <Variable className="h-3.5 w-3.5 text-node-condition" />,
      color: 'bg-node-condition/10',
    },
    {
      type: 'mathExpression',
      ...
      icon: <Sigma className="h-3.5 w-3.5 text-node-condition" />,
      color: 'bg-node-condition/10',
    },
    {
      type: 'log',
      ...
      icon: <FileText className="h-3.5 w-3.5 text-node-action" />,
      color: 'bg-node-action/10',
    },
    {
      type: 'delay',
    ...
    },
    {
      ...
      icon: <Hourglass className="h-3.5 w-3.5 text-warning" />,
      color: 'bg-warning/10',
    },
    {
      type: 'group',
    ...
    },
    {
      ...
      icon: <CalendarX className="h-3.5 w-3.5 text-node-condition" />,
      color: 'bg-node-condition/10',
    },
    {
      type: 'timings',
      ...
      <div className="shrink-0 border-b border-border p-2">
        <div className="relative">
          ...
          <Input
            ...
            placeholder="Search trading actions..."
