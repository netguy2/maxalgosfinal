    ...
    <div className={cn('workflow-node min-w-[120px] border-l-red-500', selected && 'selected')}>
      ...
      <div className="p-2">
        <div className="mb-1.5 flex items-center gap-1.5">
          <div className="flex h-5 w-5 items-center justify-center rounded bg-loss/20 text-loss">
        ...
        <div className="mt-1 space-y-0.5 text-[10px]">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="mono-data text-loss">{streamLabels[data.streamType || 'all']}</span>
          </div>
        </div>
      </div>
