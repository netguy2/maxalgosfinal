...
export interface Workflow {
  ...
  edges: Edge[]
  is_active: boolean
  /** Pins this workflow's order/position calls to one specific connected
   * broker instead of whichever is the user's primary session. null = use
   * primary session (default, unchanged behavior for all older workflows). */
  broker: string | null
