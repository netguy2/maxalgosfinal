...
Two-Factor Authentication (2FA) adds an extra layer of security to your Max Algos account. Even if someone knows your password, they can't access your account without the second factor - a time-based code from your authenticator app.
...
| Wrong account | Verify you're using Max Algos entry |
...
A: No, Max Algos uses TOTP apps only (more secure than SMS).
