# Max Algos User Guide

Welcome to the official Max Algos User Guide - your comprehensive resource for mastering algorithmic trading with Max Algos.
...
- [01 - What is Max Algos](./01-what-is-maxalgos/README.md)
...
| I want to... | Go to |
|--------------|-------|
| Understand what Max Algos does | [Module 01](./01-what-is-maxalgos/README.md) |
| Install Max Algos | [Module 04](./04-installation/README.md) |
...
- **Official Docs**: [docs.maxalgos.in](https://docs.maxalgos.in)
- **Community**: [Discord](https://www.maxalgos.in/discord)
- **Video Tutorials**: [YouTube](https://www.youtube.com/@maxalgos)
