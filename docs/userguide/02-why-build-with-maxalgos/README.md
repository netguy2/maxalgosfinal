# 02 - Why Build with Max Algos?

*"Why should I use Max Algos when I can just build my strategy directly on top of the broker's SDK or API?"*
...
**Max Algos takes care of the heavy lifting.**
...
## What Makes Max Algos Different?

### Strategy Management & Hosting

Host your **Python strategies directly inside Max Algos**, alongside strategies from TradingView, Amibroker, ChartInk, MetaTrader, Excel, or custom webhooks. Start, pause, schedule, monitor, and analyze—all from a central control plane.
...
Max Algos supports **29 Indian brokers** via a **unified API and WebSocket layer**. Write your strategy once, and run it across Zerodha, Angel One, Dhan, Upstox, Fyers, Flattrade, Firstock, and more—without rewriting code.
...
With Max Algos's **Common Symbol Format**, you don't have to worry about broker-specific quirks. Contracts, expiries, and lot sizes are maintained automatically.

| Broker | Their Format | Max Algos Format |
|--------|--------------|-----------------|
| Zerodha | `SBIN` | `SBIN` |
| Angel | `SBIN-EQ` | `SBIN` |
| Dhan | `SBIN` | `SBIN` |
...
Max Algos is production-tested with enterprise-grade security:
...
| Component | What You'd Build | Max Algos Provides |
|-----------|------------------|-------------------|
...
Max Algos ships with all this—**pre-wired, tested, and open source**.

---

## Open Source Freedom

Licensed under **AGPL**, Max Algos gives you:
...
**Max Algos gives you *infrastructure*.**
...
And when you're ready to switch brokers or expand to multi-broker setups, you'll already be on **Max Algos's unified, broker-agnostic foundation**.

---

**Previous**: [01 - What is Max Algos](../01-what-is-maxalgos/README.md)
