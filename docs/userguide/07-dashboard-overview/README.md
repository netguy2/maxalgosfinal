...
The Dashboard is your command center in Max Algos. It provides a quick snapshot of your trading activity, account status, and key metrics at a glance.
