...
The Latency Monitor tracks the time taken for various operations in Max Algos, from receiving signals to order execution. Understanding and optimizing latency is critical for algorithmic trading, especially for time-sensitive strategies.
...
│                                                                              │
│  Signal Source → Max Algos Processing → Broker API → Exchange → Execution   │
│       │               │                    │            │           │       │
...
|-----------|-------------|---------------|
| Network Latency | Signal source to Max Algos | 50-500ms |
| Processing Latency | Max Algos internal processing | 1-10ms |
| API Latency | Max Algos to Broker API | 50-200ms |
...
```
Current Setup:
Signal Source → Internet → Max Algos

Optimized Setup:
Signal Source → Same Network → Max Algos (Co-located)
