...
TradingView sends a signal
        ↓
Max Algos receives it instantly
        ↓
...
| **Python Strategy Hosting** | Host and schedule Python strategies directly in Max Algos |
...
**Benefit**: Switch brokers without changing your strategy code - Max Algos's unified API handles the translation.
...
## What Max Algos is NOT

Let's be clear about what Max Algos doesn't do:
...
1. **Next**: Learn [Why Build with Max Algos](../02-why-build-with-maxalgos/README.md)
...
**Next**: [02 - Why Build with Max Algos](../02-why-build-with-maxalgos/README.md) - Understand the value proposition.
