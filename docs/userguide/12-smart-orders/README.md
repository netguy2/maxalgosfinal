...
Smart Orders are position-aware orders that automatically calculate the correct action based on your current holdings. Instead of manually figuring out what to do, you tell Max Algos your target position, and it handles the rest.
