...
You've installed Max Algos. Now let's configure it properly for secure operation and connect it to your broker.

## Setup Wizard Overview

When you first access Max Algos, you'll go through these steps:
...
Before using Max Algos, you MUST set unique security keys.
...
4. Authorize Max Algos
5. You'll be redirected back to Max Algos
...
Congratulations! Max Algos is now set up. Your next steps:
