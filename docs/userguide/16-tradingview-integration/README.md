...
TradingView is a popular charting platform with powerful Pine Script strategy capabilities. Max Algos connects TradingView alerts to your broker for automated order execution.

## How It Works

```
┌─────────────────────────────────────────────────────────────────────────────┐
│                    TradingView → Max Algos Flow                              │
│                                                                              │
│  ┌─────────────┐     ┌─────────────┐     ┌─────────────┐     ┌──────────┐  │
│  │ TradingView │     │   Webhook   │     │  Max Algos   │     │  Broker  │  │
...
TradingView webhooks need to reach your Max Algos server from the internet.
...
```pine
//@version=5
strategy("My Max Algos Strategy", overlay=true)
...
```
https://your-maxalgos-url/api/v1/placesmartorder
```
...
| TradingView | Max Algos Exchange |
|-------------|-------------------|
...
1. Go to **Analyzer** page in Max Algos
