...
Max Algos's Telegram Bot integration provides real-time notifications and remote control capabilities directly from your Telegram app. Get trade alerts, monitor positions, and execute commands without accessing the dashboard.
...
3. Follow prompts:
   - Enter bot name (e.g., "My Max Algos Bot")
   - Enter username (e.g., "mymaxalgos_bot")
