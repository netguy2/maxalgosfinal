...
Max Algos is an open-source algorithmic trading platform that connects various trading platforms (TradingView, Amibroker, Python) to Indian stock brokers through a unified API.

### Is Max Algos free?

Yes, Max Algos is completely free and open-source. You can download, use, and modify it without any cost.

### Which brokers are supported?

Max Algos supports 29 Indian brokers including:
- Zerodha
- Angel One
- Dhan
- Upstox
...
### Can I use Max Algos for live trading?

Yes, Max Algos supports live trading with real money. However, we strongly recommend:
...
### Can I run Max Algos on a VPS/Cloud?

Yes, Max Algos can run on:
- AWS EC2/Lightsail
- Google Cloud
- DigitalOcean
- Azure
...
Most Indian brokers require daily authentication for security. This is a broker requirement, not an Max Algos limitation.

### Can I use multiple brokers?

Currently, Max Algos supports one broker at a time. You can switch between brokers by changing the configuration.
...
Yes, Max Algos fully supports F&O trading. Use correct symbol format:
- Futures: `NIFTY30JAN25FUT`
- Options: `NIFTY30JAN2521500CE`

### What is Analyzer Mode?

Analyzer Mode is Max Algos's sandbox testing environment. It simulates trading with ₹1 Crore sandbox capital using real market prices but no real money.

### Can I backtest strategies?

Max Algos is primarily for live trading and walkforward testing strategies. For backtesting:
- Use TradingView's strategy tester
- Use Amibroker's backtesting
- Use Python backtesting libraries

### What happens if Max Algos crashes during a trade?
...
### How do I connect TradingView to Max Algos?

1. Enable Max Algos accessible via internet (ngrok/cloud)
2. Create webhook alert in TradingView
3. Use Max Algos endpoint URL
...
Report security vulnerabilities to: security@maxalgos.in (or via GitHub private advisory)
...
Max Algos is community-driven. Get help through:
...
### Is Max Algos really free?

Yes, Max Algos is 100% free and open-source under the AGPL license.

### Are there any hidden costs?

No hidden costs from Max Algos. You may have:
...
### "Max Algos is a trading bot"

Max Algos is a **bridge/platform**, not a trading bot. It connects your strategy signals to your broker. You still need to create or use existing strategies.

### "I can make guaranteed profits"

No trading system guarantees profits. Max Algos is a tool - your results depend on your strategy.

### "It works without internet"

Max Algos requires internet connection to communicate with brokers and receive signals.

### "I can trade after market hours"

Max Algos follows exchange timings. F&O can be traded during extended hours as per exchange rules.
