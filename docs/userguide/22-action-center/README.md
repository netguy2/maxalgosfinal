...
The Action Center is Max Algos's order approval system for managed trading environments. It allows you to review, approve, modify, or reject orders before they're sent to your broker.

## When to Use Action Center

```
┌─────────────────────────────────────────────────────────────────────────────┐
│                    Trading Modes in Max Algos                                │
│                                                                              │
