...
Analyzer Mode is Max Algos's sandbox testing environment. It lets you test strategies with real market data but sandbox capital (₹1 Crore), ensuring you never risk real money while learning or validating strategies.
...
- New to Max Algos? Learn the interface
...
Turn on Analyzer Mode in Max Algos.
