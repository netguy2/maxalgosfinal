...
GoCharting is a modern web-based charting platform designed specifically for Indian markets. It offers TradingView-style functionality with native support for Indian exchanges. Max Algos integrates seamlessly with GoCharting's webhook system for automated trading.

## How It Works

```
┌─────────────────────────────────────────────────────────────────────────────┐
│                    GoCharting → Max Algos Flow                               │
│                                                                              │
│  ┌─────────────┐     ┌─────────────┐     ┌─────────────┐     ┌──────────┐  │
│  │ GoCharting  │     │   Webhook   │     │  Max Algos   │     │  Broker  │  │
...
GoCharting webhooks need to reach your Max Algos server from the internet.
...
2. Enter URL: `https://your-maxalgos-url/api/v1/placeorder`
...
1. Check **Order Book** in Max Algos
...
- Check Max Algos dashboard
- Review trade logs
- Verify position accuracy

## Troubleshooting

### Webhook Not Reaching Max Algos
...
2. Review Max Algos Traffic Logs
