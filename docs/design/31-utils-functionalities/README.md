...
The utils directory contains shared utility functions used across the Max Algos platform for authentication, logging, configuration, and common operations.
