...
Max Algos implements a two-phase authentication system:
1. **User Authentication** - Username/password login to Max Algos
2. **Broker Authentication** - OAuth2/TOTP/API-based login to trading broker

This design ensures users first authenticate with Max Algos before connecting to their broker account.
...
Max Algos supports 29 brokers with different authentication methods:
