...
Max Algos includes an MCP (Model Context Protocol) server that enables AI assistants like Claude, Cursor, and Windsurf to control trading operations through natural language commands.
...
```python
@mcp.tool()
def get_maxalgos_version():
    """Get Max Algos version"""
...
// ~/Library/Application Support/Claude/claude_desktop_config.json
{
  "mcpServers": {
    "maxalgos": {
      "command": "/path/to/maxalgos/.venv/bin/python3",
      "args": [
        "/path/to/maxalgos/mcp/mcpserver.py",
        "YOUR_API_KEY",
        "http://127.0.0.1:5000"
      ]
    }
...
maxalgos==1.0.45      # Max Algos Python client
...
| External: `maxalgos` package | Python client library |
