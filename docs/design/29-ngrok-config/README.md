...
Ngrok creates secure tunnels to expose your local Max Algos instance to the internet, enabling webhook integrations from TradingView, Chartink, and other external services.
...
| Connection refused | Ensure Max Algos is running |
