...
Max Algos supports Time-based One-Time Password (TOTP) for two-factor authentication. Users can enable 2FA through QR code scanning with authenticator apps like Google Authenticator, Authy, or Microsoft Authenticator.
...
│  │  otpauth://totp/Max Algos:user@example.com?secret=...&issuer=Max Algos│   │
│  │           │                                                          │   │
│  │           ▼                                                          │   │
...
def get_provisioning_uri(secret, email, issuer="Max Algos"):
...
```json
{
    ...
    "data": {
        ...
        "provisioning_uri": "otpauth://totp/Max Algos:user@example.com?secret=JBSWY3DPEHPK3PXP&issuer=Max Algos"
    }
}
```
