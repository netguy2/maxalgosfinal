...
Master contracts contain symbol mappings between Max Algos's standardized format and broker-specific formats. They are downloaded daily and cached for fast symbol resolution.
...
│  │  3. Transform to Max Algos format                                     │   │
...
│ symbol       │ VARCHAR      │ Max Algos symbol format           │
