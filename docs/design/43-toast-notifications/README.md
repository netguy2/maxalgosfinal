...
This document describes the toast notification system in Max Algos's React frontend, including guidelines for developers adding new features.

## Overview

Max Algos uses [Sonner](https://sonner.emilkowal.ski/) (v2.0.7) as the underlying toast library, wrapped with a custom utility that provides category-based filtering. This allows users to control which types of notifications they see via the **Profile > Alerts** settings.
