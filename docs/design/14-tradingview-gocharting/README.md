...
Max Algos integrates with TradingView and GoCharting platforms to receive trading signals via webhooks. These charting platforms can trigger automated trades when alert conditions are met.
...
Max Algos provides JSON generators for easy webhook configuration:
