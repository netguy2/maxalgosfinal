...
Max Algos integrates with Telegram to provide real-time trading notifications, account information, and bot commands. Users can configure their Telegram bot to receive order alerts, position updates, and execute queries.
...
│ user_id          │ VARCHAR(255) │ Max Algos user ID             │
...
├──────────────────┼──────────────┼──────────────────────────────┤
│ id               │ INTEGER PK   │ Auto-increment               │
│ user_id          │ VARCHAR(255) │ Max Algos user ID (unique)    │
...
| /link `<api_key> <host_url>` | Link your Max Algos account | /link abc123 http://127.0.0.1:5000 |
