...
Max Algos implements browser-side security measures including session management, CSRF protection, secure cookies, and content security policies.
...
app.config.update(
    ...
    SESSION_COOKIE_NAME='maxalgos_session',
