...
Max Algos uses SMTP for sending email notifications, password reset links, and alerts. SMTP credentials are stored encrypted in the database for security.
...
You requested to reset your Max Algos password.
...
<body>
    ...
    <p>You requested to reset your Max Algos password.</p>
