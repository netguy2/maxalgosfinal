...
Max Algos uses **5 separate databases** for data isolation, performance optimization, and specialized use cases. This separation prevents contention and allows each database to be optimized for its specific workload.
...
│                                                                              │
│  ┌─────────────────┐  ┌─────────────────┐  ┌─────────────────┐             │
│  │   maxalgos.db   │  │    logs.db      │  │   latency.db    │             │
...
## Database 1: Main Database (maxalgos.db)
...
│ overhead_ms      │ FLOAT        │ Max Algos overhead│
...
| overhead_ms | Total Max Algos overhead |
