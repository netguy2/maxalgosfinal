...
Max Algos follows a modular architecture with clear separation of concerns. This document provides a comprehensive map of the project structure to help developers navigate the codebase effectively.
...
├── flow_maxalgos_client.py       # Flow API client
│
...
```
db/
├── maxalgos.db               # Main database (users, orders, settings)
