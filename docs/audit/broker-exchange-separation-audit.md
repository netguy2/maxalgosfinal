...
Max Algos supports 30+ Indian stock brokers and 1 crypto exchange (Delta Exchange), with more crypto exchanges planned. The current frontend treats all brokers uniformly, presenting a mixed UI where:
...
{
    "Plugin Name": "zerodha",
    "Description": "Zerodha Max Algos Plugin",
    "Version": "1.0",
    "Author": "Rajandran R"
}
```
...
- **Done**:
  - Bruno collections split into `collections/maxalgos/IN_stock/` and `collections/maxalgos/crypto/`
...
```json
{
    ...
    "Description": "Delta Exchange Max Algos Plugin",
    "Version": "1.0",
...
```json
{
    ...
    "Description": "Firstock Max Algos Plugin",
    "Version": "1.0",
    "Author": "Rajandran R",
    "broker_type": "stock",
...
{
    "Plugin Name": "groww",
    "Description": "Groww Max Algos Plugin",
    "Version": "1.0",
    "Author": "Rajandran R",
    "broker_type": "stock",
