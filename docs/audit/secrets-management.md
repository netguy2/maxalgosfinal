...
This assessment covers how Max Algos protects your sensitive data: broker credentials, API keys, and encryption secrets.

**Risk Level**: Critical (data sensitivity)
**Status**: Good

## What Secrets Does Max Algos Store?
...
|------|----------|-------------|
| `maxalgos.db` | Users, orders, settings | High |
...
- [ ] Strong password for Max Algos login
...
**Actions**:
1. Logout from Max Algos
2. Revoke broker tokens (in broker dashboard)
3. Generate new API key in Max Algos
