...
This assessment covers the security of Max Algos's REST API, focusing on protecting your trading operations from unauthorized access via webhooks.
...
Max Algos API is accessed in two scenarios:
