...
Max Algos implements authentication to protect access to your personal trading dashboard and prevent unauthorized order placement.
...
Max Algos uses Argon2id - the winner of the Password Hashing Competition and OWASP's top recommendation.
...
Max Algos supports time-based one-time passwords (TOTP) compatible with:
