...
All notable changes to Max Algos will be documented in this file.
...
- Order field names aligned with Max Algos schema
...
- What is Max Algos, Key Concepts, System Requirements
...
- Max Algos symbol format reference
...
### Other Documentation
- Why Build with Max Algos guide
...
- `db/maxalgos.db` - Main database (users, orders, settings)
