# Max Algos Services Documentation

## Overview

Max Algos Services are Python functions that provide programmatic access to trading operations. These services mirror the functionality of the Max Algos SDK but are designed for internal use within the Max Algos application. Each service function accepts the same request parameters and returns the same responses as documented in the Max Algos SDK.
...
**Location:** `maxalgos/services/place_order_service.py`
...
| api_key | str | Conditional | Max Algos API key (for API-based calls) |
...
**Location:** `maxalgos/services/place_smart_order_service.py`
...
| api_key | str | Conditional | Max Algos API key |
...
**Location:** `maxalgos/services/place_options_order_service.py`
...
**Location:** `maxalgos/services/options_multiorder_service.py`
...
**Location:** `maxalgos/services/basket_order_service.py`
...
**Location:** `maxalgos/services/split_order_service.py`
...
**Location:** `maxalgos/services/modify_order_service.py`
...
**Location:** `maxalgos/services/cancel_order_service.py`
...
**Location:** `maxalgos/services/cancel_all_order_service.py`
...
**Location:** `maxalgos/services/close_position_service.py`
...
**Location:** `maxalgos/services/orderstatus_service.py`
...
**Location:** `maxalgos/services/openposition_service.py`
...
**Location:** `maxalgos/services/quotes_service.py`
...
**Location:** `maxalgos/services/depth_service.py`
...
**Location:** `maxalgos/services/history_service.py`
...
**Location:** `maxalgos/services/intervals_service.py`
...
**Location:** `maxalgos/services/symbol_service.py`
...
**Location:** `maxalgos/services/search_service.py`
...
**Location:** `maxalgos/services/expiry_service.py`
...
**Location:** `maxalgos/services/instruments_service.py`
...
| api_key | str | Yes | Max Algos API key |
...
**Location:** `maxalgos/services/option_symbol_service.py`
...
**Location:** `maxalgos/services/option_chain_service.py`
...
**Location:** `maxalgos/services/synthetic_future_service.py`
...
**Location:** `maxalgos/services/option_greeks_service.py`
...
**Location:** `maxalgos/services/funds_service.py`
...
**Location:** `maxalgos/services/margin_service.py`
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| apikey | str | Yes | Max Algos API key |
...
**Location:** `maxalgos/services/orderbook_service.py`
...
**Location:** `maxalgos/services/tradebook_service.py`
...
**Location:** `maxalgos/services/positionbook_service.py`
...
**Location:** `maxalgos/services/holdings_service.py`
...
**Location:** `maxalgos/services/market_calendar_service.py`
...
**Location:** `maxalgos/services/analyzer_service.py`
...
The Telegram Alert Service provides automated notifications for order-related events via Telegram. This service is not part of the SDK yet but is available for internal use within Max Algos.

**Location:** `maxalgos/services/telegram_alert_service.py`
