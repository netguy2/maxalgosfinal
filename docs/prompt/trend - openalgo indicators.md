...
Trend indicators help identify the direction and strength of market trends. All examples use real market data fetched via Max Algos API.

### Data Setup

```python
from maxalgos import api, ta
import pandas as pd
...
This documentation demonstrates how to use Max Algos trend indicators with real market data fetched via the Max Algos API, maintaining pandas DataFrame structure throughout the analysis process.
...
```
GET https://docs.maxalgos.in/trading-platform/python/indicators/trend.md?ask=<question>
```
