...
Complete Docker deployment and troubleshooting documentation for Max Algos.
...
Max Algos uses a **multi-stage build** with the following configuration:
...
docker ps --filter "name=maxalgos"

# Test numba/scipy
docker exec maxalgos python -c "import numba, scipy; print('✓ OK')"
...
- [Main Documentation](https://docs.maxalgos.in) - Official documentation site
