...
API docs: <https://docs.maxalgos.in/api-documentation/v1/orders-api/placegttorder>
...
```
GET https://docs.maxalgos.in/change-log/release/version-2.0.0.8-released.md?ask=<question>
```
