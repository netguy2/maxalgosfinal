...
**Max Algos Python SDK 1.0.51 — connection pooling fix**

Released to PyPI alongside this version and pinned by the platform (`maxalgos==1.0.50` → `1.0.51`).
...
* Available at <https://pypi.org/project/maxalgos/1.0.51/>.
...
* `maxalgos` SDK pin: `1.0.50` → `1.0.51` (PyPI: <https://pypi.org/project/maxalgos/1.0.51/>) — connection-pooling fix.
* `idna` `3.11` → `3.15`.
...
* `maxalgos==1.0.50` → `maxalgos==1.0.51`
* `idna==3.11` → `idna==3.15`
...
* **Python SDK on PyPI**: <https://pypi.org/project/maxalgos/1.0.51/>
