...
Python Strategies enables traders to run custom Python trading algorithms within Max Algos, with process isolation, market-aware scheduling, and comprehensive lifecycle management.
...
| ID | Requirement | Priority |
|----|-------------|----------|
| FR6.1 | Max Algos SDK available to strategies | P0 |
| FR6.2 | Environment variables for API key | P0 |
| FR6.3 | Access to all Max Algos API endpoints | P0 |
...
# Configuration
API_KEY = os.getenv('MAX_ALGOS_APIKEY')
HOST = os.getenv('MAX_ALGOS_HOST', 'http://127.0.0.1:5000')
SYMBOL = 'SBIN'
EXCHANGE = 'NSE'
QUANTITY = 1
