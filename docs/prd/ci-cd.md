...
Automated CI/CD pipeline for Max Algos v2 providing continuous integration, security scanning, and quality gates for the Flask backend and React frontend. Designed for minimal maintenance overhead and fast developer feedback.
