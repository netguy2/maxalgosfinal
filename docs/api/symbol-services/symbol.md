...
|-----------|-------------|-------------------|---------------|
| apikey | Your Max Algos API key | Mandatory | - |
| symbol | Trading symbol in Max Algos format | Mandatory | - |
...
| symbol | string | Max Algos standard symbol |
| brsymbol | string | Broker-specific symbol |
| exchange | string | Max Algos exchange code |
