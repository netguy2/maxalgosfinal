...
<html>
<head>
    <title>System Health Monitor - Max Algos</title>
    <!-- Add your styles -->
</head>
<body>
    <div class="container">
...
tail -f logs/maxalgos.log | grep -i health
...
fd_gauge = Gauge('maxalgos_fd_count', 'File descriptor count')
memory_gauge = Gauge('maxalgos_memory_mb', 'Memory usage in MB')
