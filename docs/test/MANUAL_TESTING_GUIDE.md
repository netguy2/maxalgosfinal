# Max Algos v2.0 - Comprehensive Manual Testing Guide
...
| Test | Steps | Expected | Status |
|------|-------|----------|--------|
| Build image | `docker build -t maxalgos .` | Image built | [ ] |
| Run container | `docker run -p 5000:5000 maxalgos` | App accessible | [ ] |
...
## Appendix: Max Algos Symbol Format
