...
class ConfigurableEMABot:
    def __init__(self):
        ...
        print("[BOT] Max Algos Trading Bot Started")
        ...
        if os.getenv("MAX_ALGOS_STRATEGY_EXCHANGE"):
            print(
                f"[BOT] Exchange resolved from MAX_ALGOS_STRATEGY_EXCHANGE "
...
if __name__ == "__main__":
    if not API_KEY or API_KEY == "maxalgos-apikey":
        print(
            "[WARNING] MAX_ALGOS_API_KEY is not set in environment. "
            "Set it before running in live mode."
        )

    print("\n" + "=" * 60)
    print(" MAX_ALGOS EMA STRATEGY - READY TO RUN")
    print("=" * 60)
