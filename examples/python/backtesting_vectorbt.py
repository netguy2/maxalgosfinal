...
Author : Max Algos GPT
Description: Backtests 10/20 EMA crossover strategy on RELIANCE 5m data
             Data fetched from Max Algos API, backtested with VectorBT
"""

print("🔁 Max Algos Python Bot is running.")
...
def fetch_historical_data():
    ...
    # Max Algos history() returns DataFrame directly
...
if __name__ == "__main__":
    try:
        # Step 1: Fetch data from Max Algos
